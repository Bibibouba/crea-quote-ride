    ...
    try {
      const savedQuote = await quoteService.createQuote({
        ...
        quoteData: {
          ...
          departure_coordinates: departureCoordinates as [number, number],
          arrival_coordinates: destinationCoordinates as [number, number],
          ...
          return_coordinates: customReturnCoordinates as [number, number],
