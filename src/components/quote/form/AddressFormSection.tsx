      ...
      {departureCoordinates && destinationCoordinates && (
        <div className="mt-4 border p-3 rounded-md bg-gradient-to-b from-white to-blue-50/30">
          ...
          {estimatedDistance > 0 && estimatedDuration > 0 && (
            <div className="flex justify-between mt-3 text-sm bg-white/80 p-2 rounded-md shadow-sm">
              <p className="text-muted-foreground">Distance estimée: <span className="font-medium text-primary">{estimatedDistance} km</span></p>
              <p className="text-muted-foreground">Durée estimée: <span className="font-medium text-primary">{estimatedDuration} min</span></p>
            </div>
          )}
        </div>
      )}
